...
@section('contenido')
    <div class="md:flex md:items-center">
        ...
        <div class="md:w-1/2 px-10 mr-5 ml-5 bg-white p-10 rounded-lg shadow-xl mt-10 md:mt-0">
            <form action="{{ route('register') }}" method="POST" novalidate>
                @csrf
                <div class="mb-5">
                    <label for="titulo" class="mb-2 block uppercase text-gray-500 font-black">
                        Titulo
                    </label>
                    <input
                        id="titulo"
                ...
                <div class="mb-5">
                    <label for="descripcion" class="mb-2 block uppercase text-gray-500 font-black">
                        Descripción
                    </label>
                    <textarea
                        id="descripcion"
